...
<head>
	...
	<title>Online Food Delivery | Forgot Password</title>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-light mt-4x">Online Food Delivery Forgot Password</h1>
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								...
								<div class="card-footer text-center" style="padding-top: 30px;">
									<div class="small"><a href="login.php" class="btn btn-primary">Back to Login</a></div>
								</div>
							</div>
						</div>
					</div>
